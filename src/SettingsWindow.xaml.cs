...
namespace STGameTranslation
{
    ...
    public partial class SettingsWindow : Window
    {
        ...
        // Python environment setup button
        private async void SetupPythonEnvButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                MessageBoxResult result = System.Windows.MessageBox.Show(
                    $"Are you sure you want to install Python dependencies for PaddleOCR?\n\n" +
                ...
                {
                    // Show status message
                    MainWindow.Instance.SetStatus($"Setting up Python environment");
                    ...
                    MainWindow.Instance.SetStatus($"Python environment setup is completed");
                }
            }
            catch (Exception ex)
            {
