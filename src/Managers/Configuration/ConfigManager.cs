...
namespace ScreenTranslation
{
    public class ConfigManager
    {
        ...
        private List<(string Phrase, bool ExactMatch)>? _cachedIgnorePhrases;
        ...
        private string? _lastIgnorePhrasesValue;
        ...
        // Helper method to parse color from hex string with caching
        private System.Windows.Media.Color ParseColor(string colorHex)
        {
            ...
            // Check cache first
            if (_colorCache.TryGetValue(colorHex, out System.Windows.Media.Color cachedColor))
                return cachedColor;
            ...
            System.Windows.Media.Color defaultColor = System.Windows.Media.Colors.White;
            _colorCache[colorHex] = defaultColor;
            return defaultColor;
        }
        ...
        public List<(string Phrase, bool ExactMatch)> GetIgnorePhrases()
        {
            ...
            if (_cachedIgnorePhrases != null && _lastIgnorePhrasesValue == value)
            {
