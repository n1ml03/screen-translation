...
namespace STGameTranslation
{
    public class ConfigManager
    {
        ...
        public const string OPENAI_REALTIME_ENDPOINT = "openai_realtime_endpoint";
        ...
        public const string defaultChatGptPrompt = "Your task is to translate the source_language text in the following JSON data to target_language " +
                    ...
                    "* |||ST_SEPARATOR||| to separate the sentences, you don't need to translate it but the result must still include |||ST_SEPARATOR||| \n" +
        ...
        private ConfigManager()
        {
            ...
            else
            {
                ...
                _currentTranslationService = "ChatGPT";
        ...
        private void CreateDefaultConfig()
        {
            ...
            _configValues[CHATGPT_ENDPOINT] = "https://api.openai.com/v1/chat/completions";
        ...
        public void SetOcrMethod(string method)
        {
            ...
            if (method == "Windows OCR" || method == "PaddleOCR" || method == "OneOCR")
            {
            ...
            {
                Console.WriteLine($"WARNING: Invalid OCR method: {method}. Must be 'Windows OCR' or 'PaddleOCR' or 'OneOCR'");
            }
        }
        ...
        {
            return GetValue(TTS_SERVICE, "Windows TTS"); // Default to Windows TTS
        }
        ...
        {
            return GetValue(CHATGPT_ENDPOINT, "https://api.openai.com/v1/chat/completions");
        }
        ...
        public string GetOpenAiRealtimeEndpoint()
        {
            return GetValue(OPENAI_REALTIME_ENDPOINT, "wss://api.openai.com/v1/realtime?model=gpt-4o-realtime-preview");
        }
        public void SetOpenAiRealtimeEndpoint(string endpoint)
        {
            _configValues[OPENAI_REALTIME_ENDPOINT] = endpoint;
            SaveConfig();
        }
